...
export default component$(() => {
  return (
    <>
      <Individualproject title="Rabble Messaging App" type="Full-stack" tools={['sveltekit','pocketbase', 'nodejs', 'tailwind']} color="#29B2AF" linkCode="https://github.com/underwoodbrady/pocketbase-discord-clone">
