    ...
    return (
        <section class="relative text-white max-w-7xl mx-auto flex h-[calc(100vh-72px)]">
            <div class="absolute w-full top-[40%] lg:w-5/12 lg:top-[35%] -translate-y-1/2">
                ...
                <h3 class="text-lg mb-6 lg:text-xl lg:mb-8 text-neutral-300 max-w-xl">I am a full-stack software developer and web designer optimizing for <span>simplicity</span> and <span>performance</span></h3>
