    ...
    return (
        <section class="relative max-w-7xl mx-auto flex justify-between mt-12 mb-8 w-full space-x-16">
            <div class="bg-[rgb(33,33,33)] p-6 w-[28%] h-full rounded-sm">
                ...
                <p class="font-semibold text-neutral-500 mb-2">Location</p>
                <p class="text-white mb-4">Maple Valley, WA</p>
                <p class="font-semibold text-neutral-500 mb-2">Email</p>
            ...
            <div class="flex-1 flex flex-col items-start h-full justify-between">
                ...
                <p class="text-neutral-300 text-lg mb-6 ">
                    I recently graduated from Montana State University with a degree in Computer Science. I have always had a keen interest in software development and business management and am always ....
                </p>
                <p class="text-neutral-300 text-lg mb-6 ">
