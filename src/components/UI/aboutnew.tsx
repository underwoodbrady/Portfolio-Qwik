...
export default component$(() => {
    return (
        <section class="relative max-w-7xl mx-auto flex flex-row justify-between mt-12 mb-8 w-full lg:space-x-16">
            <div class="bg-[rgb(33,33,33)] p-6 lg:w-[26%] h-full rounded-sm hidden lg:inline">
            ...
            <div class="flex-1 flex flex-col items-start h-full justify-between mb-8 lg:mb-0">
                <h2 class=" text-4xl lg:text-5xl text-neutral-200 tracking-normal font-semibold mb-8 lg:mb-12">about me</h2>
