...
export default component$<Props>(({ title, colorRed, colorGreen, colorBlue, link }) => {
    return (
        <div class="relative flex items-center group justify-between bg-[rgb(33,33,33)] hover:bg-[rgb(36,36,36)] w-full h-full p-6 lg:p-8 rounded-sm border-4" style={`border-color:rgb(${colorRed},${colorGreen},${colorBlue})`}>
